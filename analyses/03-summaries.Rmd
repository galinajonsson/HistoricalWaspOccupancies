...
# Subset the first six characters of the "visit" colunm, which corresponds to the grid cell
spp_vis_crabro$year <- substr(spp_vis_crabro$visit, start = 14, stop = 17)
