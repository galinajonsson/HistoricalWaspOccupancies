...
# Save modelSumDF
#write.csv(modelSumDF, '../outputs/SummaryTables/modelSummary.csv', row.names=FALSE)

# Save sppModelSumDF
#write.csv(sppModelSumDF, '../outputs/SummaryTables/sppLevelSummary.csv', row.names=FALSE)
```
