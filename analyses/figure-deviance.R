# Produce figure for Deviance plot
...
Deviance_fig <- ggplot(data = DICResults_all , aes(closurePer, Deviance, color=Species)) + 
  theme_bw() + 
...
require("cowplot")
Deviance_fig <-ggdraw() + draw_plot(Deviance_fig, x = 0, y = 0, width = 1, height = 0.9) +
