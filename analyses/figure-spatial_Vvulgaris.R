...
# Add squares to map colouring by number of species
#BRCmap::plotUK_gr(reformat_gr(spp_vis_vulgaris$site, prec_out = 10000, precision = NULL, pad_gr = FALSE), col="grey25", border = FALSE)
BRCmap::plotUK_gr_cats(reformat_gr(spp_vis_crabro_source$site, prec_out = 10000, precision = NULL, pad_gr = FALSE), spp_vis_germanica_source$source, att_col = (colorblind_pal()(3)), border = FALSE)
