...
plot1yr_occu_vv <- function(mod1, mod2, mod3, mod4){
...
new_data4 <- spp_data4[grepl(paste0("^psi.fs", reg_agg, "\\["),spp_data4$X),]
...
# This function plots all occupancy estimates at 1x1, 2x2, 5x5 and 10x10 km resolutions
plot5yr_occu_vv <- function(mod1, mod2, mod3, mod4){
...
# This function plots all occupancy estimates at 1x1, 2x2, 5x5 and 10x10 km resolutions
plot10yr_occu_vv <- function(mod1, mod2, mod3, mod4){
...
plot1yr_occu_vg <- function(mod1, mod2, mod3, mod4){
...
# This function plots all occupancy estimates at 2x2, 5x5 and 10x10 km resolutions
plot5yr_occu_vg <- function(mod1, mod2, mod3, mod4){
...
plot10yr_occu_vg <- function(mod1, mod2, mod3, mod4){
  ########## 1x1km
  # gets summary output from the BUGS files 
  main = mod1$SPP_NAME
  reg_agg =''
...
plot1yr_occu_vc <- function(mod1, mod2, mod3, mod4){
...
# This function plots all occupancy estimates at 1x1, 2x2, 5x5 and 10x10 km resolutions
plot5yr_occu_vc <- function(mod1, mod2, mod3, mod4){
...
# This function plots all occupancy estimates at 1x1, 2x2, 5x5 and 10x10 km resolutions
plot10yr_occu_vc <- function(mod1, mod2, mod3, mod4){
...
#### Plot V. vulgaris
Vvulgaris1yr <- plot1yr_occu_vv(results_1kmgrid_date_year_vv, 
                                results_2kmgrid_date_year_vv, 
                                results_5kmgrid_date_year_vv, 
                                results_10kmgrid_date_year_vv)

Vvulgaris5yr <- plot5yr_occu_vv(results_1kmgrid_date_5years_vv, 
                                results_2kmgrid_date_5years_vv,
                                results_5kmgrid_date_5years_vv,
                                results_10kmgrid_date_5years_vv)

Vvulgaris10yr <- plot10yr_occu_vv(results_1kmgrid_date_10years_vv, 
...
occu_fig <-ggdraw() + draw_plot((grid.arrange(grobs= gs,
...
#ggsave(filename = "Figure_4.pdf", plot = occu_fig, width = 220, height = 180, 
...
dpi = 600
plot.new()
legend <- legend("center", legend = c("1 km\u00b2", "2 km\u00b2", "5 km\u00b2", "10 km\u00b2"),
       col = c("#999999","#E69F00","#56B4E9", "#009E73"), lty = 1, lwd =3, bty="n",
       title = paste("Spatial\nresolution")) 
#ggsave(filename = "Legend_Figure_5_6.pdf", plot = legend, width=0.4*dpi,height=1*dpi, 
#       dpi = 600, units = "mm", device='pdf', path = "./figs")